class Player {
  ...
  void move(float ms) {
    if (isMovingUp) {
      if (e.em.checkBlockType((int)(this.x+50)/100,constrain((int)(this.y/100)-1,0,400)).equals("BlankTile") && e.em.checkBlockType((int)(this.x+50)/100,constrain((int)(this.y/100)-1,0,400)).equals("BlankTile")) {
        //e.console("empty");
        y -= ySpeed * 2 *  ms;
      }
    }
